...
<t:datagrid actionUrl="payController.do?dataGrid" name="payList" title="付款管理" fit="true" fitColumns="true" queryMode="group" idField="id">
	...
	<t:dgConfOpt url="payController.do?payOut&id={id}" message="确定要付款吗？" title="付款"></t:dgConfOpt>
</t:datagrid>