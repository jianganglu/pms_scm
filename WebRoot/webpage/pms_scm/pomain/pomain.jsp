...
<body style = "overflow-y: hidden" scroll="no">
	<t:formvalid layout="div" dialog="true" formid="formobj" action="pomainController.do?savePomain">
		...
		<input type="hidden" name="pomainId" value="${p.pomainId}"/>
		<fieldset class="step">
		 	<div class="form">
		 	...
		 	<div class="form">
		 		...
		 		<input type="text" id="num" name="num" class="inputxt" value="${p.num}"/>
		 		<span class="Validform_checktip"></span>
		 	</div>
		 	<div class="form">
		 		<label class="Validform_label">
		 		...
		 		<c:choose>
		 			...
		 			<c:otherwise>
		 				<input type="text" id="unitPrice" name="unitPrice" class="inputxt" value="${p.unitPrice}"/>
		 			</c:otherwise>
		 		</c:choose>
		 		<span class="Validform_checktip"></span>
		 	</div>
		 	<div class="form">
		 		...
		 		<input type="text" id="totalPrice" name="totalPrice" class="inputxt" value="${p.totalPrice}" readonly="readonly"/>
		 		<span class="Validform_checktip"></span>
		 	</div>
		 	<div class="form">
		 		<label class="Validform_label">
		 		...
		 		<input type="text" name="vender" class="inputxt" value="${p.vender}"/>
		 		<span class="Validform_checktip"></span>
		 	</div>
		 	<div class="form">
		 		<label class="Validform_label">
		 		...
		 		<c:choose>
		 			<c:when test="${p.payType != null}">
		 				<input class="inputxt" type="text" name="payType" value="${p.payType }" readonly/>
		 			</c:when>
		 			<c:otherwise>
		 	...
		 	<div class="form">
		 		...
		 		<c:choose>
		 			...
		 			<c:otherwise>
		 				<input type="text" name="status" class="inputxt" value="${p.status}"/>
		 			</c:otherwise>
		 		</c:choose>
		 		<span class="Validform_checktip"></span>
		 	</div>
